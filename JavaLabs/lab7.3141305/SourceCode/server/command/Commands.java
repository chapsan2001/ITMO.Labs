...
public class Commands {
    ...
    public Commands() {
        ...
        commands.put(CommandNames.REMOVE_LOWER_KEY, RemoveLowerKeyCommand.class);
        commands.put(
                CommandNames.REMOVE_ANY_BY_NUMBER_OF_PARTICIPANTS, RemoveAnyByNumberOfParticipantsCommand.class);
