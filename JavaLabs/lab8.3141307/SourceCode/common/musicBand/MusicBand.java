...
public class MusicBand implements Comparable<MusicBand>, Serializable {
  ...
  public void setId(Integer id) throws ValidationException {
    if (id == null) {
      throw new ValidationException(ResourceBundle.getBundle("MusicBand").getString("wrongIdNull"));
    }
    if (id <= 0) {
      throw new ValidationException(ResourceBundle.getBundle("MusicBand").getString("wrongId"));
    }
  ...
  public void setName(String name) throws ValidationException {
    if (name == null) {
      throw new ValidationException(
          ResourceBundle.getBundle("MusicBand").getString("wrongNameNull"));
    }
    if (name.isEmpty()) {
      throw new ValidationException(
          ResourceBundle.getBundle("MusicBand").getString("wrongNameEmpty"));
    }
  ...
  public void setCoordinates(Coordinates coordinates) throws ValidationException {
    if (coordinates == null) {
      throw new ValidationException(
          ResourceBundle.getBundle("MusicBand").getString("wrongCoordinates"));
    }
  ...
  public void setCreationDate(LocalDate creationDate) throws ValidationException {
    if (creationDate == null) {
      throw new ValidationException(
          ResourceBundle.getBundle("MusicBand").getString("wrongStartDateNull"));
    }
  ...
  public void setNumberOfParticipants(long numberOfParticipants) throws ValidationException {
    if (numberOfParticipants <= 0) {
      throw new ValidationException(
          ResourceBundle.getBundle("MusicBand").getString("wrongNumberOfParticipants"));
    }
