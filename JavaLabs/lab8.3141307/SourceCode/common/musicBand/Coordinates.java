...
public class Coordinates implements Serializable {
  ...
  public void setX(Long x) throws ValidationException {
    if (x == null) {
      throw new ValidationException(
          ResourceBundle.getBundle("Coordinates").getString("wrongXNull"));
    }
    if (x <= -492) {
      throw new ValidationException(ResourceBundle.getBundle("Coordinates").getString("wrongX"));
    }
  ...
  public void setY(float y) throws ValidationException {
    if (y >= 19) {
      throw new ValidationException(ResourceBundle.getBundle("Coordinates").getString("wrongY"));
    }
